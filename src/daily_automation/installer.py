...
class InstallerApp:
    def __init__(self):
        ...
        self.app_base = self.source_dir / 'DailyAutomationApp'
        self.app_exe = self.app_base / APP_EXE_NAME
    ...
    def _build_license(self):
        ...
        license_text = (
            f'{APP_NAME} (MVP\u6d4b\u8bd5\u7248) \u6700\u7ec8\u7528\u6237\u8bb8\u53ef\u534f\u8bae\n\n'
            '\u7248\u6743\u6240\u6709\uff08Copyright\uff09\n'
            f'{APP_NAME}\uff08\u4ee5\u4e0b\u7b80\u79f0\u201c\u672c\u8f6f\u4ef6\u201d\uff09\u4e3a\u514d\u8d39\u5f00\u6e90\u8f6f\u4ef6\uff0c\u4ec5\u4f9b\u4e2a\u4eba\u5b66\u4e60\u3001\u7814\u7a76\u548c\u975e\u5546\u4e1a\u7528\u9014\u4f7f\u7528\u3002\n\n'
            '\u4f7f\u7528\u8bb8\u53ef\n'
            '1. \u6388\u4e88\u7528\u6237\u5b89\u88c5\u548c\u4f7f\u7528\u672c\u8f6f\u4ef6\u7684\u975e\u72ec\u5360\u3001\u4e0d\u53ef\u8f6c\u8ba9\u7684\u6743\u5229\u3002\n'
            '2. \u5141\u8bb8\u7528\u6237\u4e3a\u5b66\u4e60\u548c\u7814\u7a76\u76ee\u7684\u590d\u5236\u3001\u4fee\u6539\u548c\u5206\u53d1\u672c\u8f6f\u4ef6\u3002\n'
            '3. \u4e0d\u5f97\u5c06\u672c\u8f6f\u4ef6\u7528\u4e8e\u4efb\u4f55\u5546\u4e1a\u7528\u9014\uff0c\u5305\u62ec\u4f46\u4e0d\u9650\u4e8e\u5546\u4e1a\u8f6c\u552e\u3001\u5546\u4e1a\u6258\u7ba1\u6216\u96c6\u6210\u5230\u5546\u4e1a\u4ea7\u54c1\u4e2d\u3002\n'
            '4. \u4fee\u6539\u540e\u7684\u7248\u672c\u5fc5\u987b\u660e\u786e\u6807\u6ce8\u4e3a\u4fee\u6539\u7248\u672c\uff0c\u4e0d\u5f97\u4f2a\u88c5\u4e3a\u539f\u59cb\u7248\u672c\u3002\n\n'
            '\u514d\u8d23\u6761\u6b3e\n'
            '1. \u672c\u8f6f\u4ef6\u6309\u201c\u73b0\u72b6\u201d\u63d0\u4f9b\uff0c\u4e0d\u63d0\u4f9b\u4efb\u4f55\u5f62\u5f0f\u7684\u660e\u793a\u6216\u6697\u793a\u4fdd\u8bc1\u3002\n'
            '2. \u4f7f\u7528\u8005\u5e94\u81ea\u884c\u627f\u62c5\u4f7f\u7528\u672c\u8f6f\u4ef6\u7684\u98ce\u9669\uff0c\u5f00\u53d1\u8005\u4e0d\u5bf9\u4efb\u4f55\u56e0\u4f7f\u7528\u672c\u8f6f\u4ef6\u9020\u6210\u7684\u76f4\u63a5\u6216\u95f4\u63a5\u635f\u5931\u627f\u62c5\u8d23\u4efb\u3002\n'
            '3. \u672c\u8f6f\u4ef6\u4e3aMVP\uff08Minimum Viable Product\uff09\u6d4b\u8bd5\u7248\u672c\uff0c\u53ef\u80fd\u5b58\u5728\u672a\u9884\u89c1\u7684\u7f3a\u9677\u6216\u95ee\u9898\u3002\n\n'
            '\u9690\u79c1\u4fdd\u62a4\n'
            '1. \u672c\u8f6f\u4ef6\u7eaf\u672c\u5730\u8fd0\u884c\uff0c\u4e0d\u6536\u96c6\u3001\u4e0d\u4e0a\u4f20\u4efb\u4f55\u7528\u6237\u6570\u636e\u3002\n'
            '2. \u6240\u6709\u914d\u7f6e\u6587\u4ef6\u548c\u6570\u636e\u4ec5\u5b58\u50a8\u5728\u7528\u6237\u672c\u5730\u8bbe\u5907\u3002\n'
            '3. \u672c\u8f6f\u4ef6\u4e0d\u5305\u542b\u4efb\u4f55\u5f62\u5f0f\u7684\u81ea\u52a8\u4e0a\u62a5\u6216\u8fdc\u7a0b\u901a\u4fe1\u529f\u80fd\uff08\u9664\u975e\u7528\u6237\u660e\u786e\u542f\u7528\u4e86\u90ae\u4ef6\u63a8\u9001\u529f\u80fd\uff09\u3002'
        )
    ...
    def _do_install(self):
        ...
        try:
            ...
            if self.app_exe.exists():
                ...
                app_internal = self.app_base / '_internal'
                if app_internal.exists():
                    self._set_progress(18, "\u590d\u5236\u8fd0\u884c\u65f6\u4f9d\u8d56...")
                    shutil.copytree(str(app_internal), str(install_dir / '_internal'), dirs_exist_ok=True)
                    self._log("\u2713 \u590d\u5236\u8fd0\u884c\u65f6\u4f9d\u8d56\u5e93 (_internal)")
            else:
    ...
    def _next_step(self):
        if self.current_step == 6 and self._install_done:
    ...
    def _on_cancel(self):
        if self.current_step == 6 and not self._install_done:
            return
